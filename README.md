...
[NEA](https://github.com/CypoesGraphics/Never-Ending-Anime) is a chrome extension that improves the Crunchyroll experience for power users. It's features include:
...
NEA allows you to customize it's functionality with an options menu, which can be accessed by clicking the logo in the top bar.

![options](https://i.imgur.com/mgF45dA.png)
